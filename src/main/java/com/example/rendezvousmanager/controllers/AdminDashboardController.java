...
public class AdminDashboardController {
    ...
    private void goToUtilisateurs() {
        SceneManager.navigateTo("utilisateur-view");
    }
    
    @FXML
    private void goToCategories() {
        SceneManager.navigateTo("categorie-view");
    }
    
    @FXML
    private void goToLieux() {
        SceneManager.navigateTo("lieu-view");
    }
    ...
    private void goToStatistiques() {
        SceneManager.navigateTo("statistiques-view");
    }
}
